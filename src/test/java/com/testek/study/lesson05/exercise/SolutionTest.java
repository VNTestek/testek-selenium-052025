...
public class SolutionTest {
    ...
    public void testDynamicLocator() {
        ...
        String lblSubjectsXPath = String.format(FORM_XPATH_LABEL_TEXT, "label-subjects");
        String lblHobbiesXPath = String.format(FORM_XPATH_LABEL_TEXT, "label-hobbies");
        ...
        //Checkbox
        String chkReadingXPath = String.format(FORM_XPATH_INPUT_PLACEHOlDER, "reading");
