...
//Hello
    ...
    public void testInteraction() {
        ...
        String txtAreaXPath01 = "//textarea[@placeholder=\"Enter your address\"]";
        webDriver.findElement(By.xpath(txtAreaXPath01));

        String txtAreaCSS01="textarea[placeholder=\"Enter your address\"]";
        webDriver.findElement(By.cssSelector(txtAreaCSS01));

        String txtAreaXPath02 = "//textarea[@test-id=\"textarea-address\"]";
        webDriver.findElement(By.xpath(txtAreaXPath02));

        String txtAreaCSS02="textarea[test-id=\"textarea-address\"]";
        webDriver.findElement(By.cssSelector(txtAreaCSS02));
    }
}
