...
public class SolutionTest {
    ...
    public void testStudentForm() {
        ...
        sendKeysToElement(By.xpath(String.format(FORM_XPATH_PLACEHOLDER_INPUT, "Enter your first name")), "Vu", true);
        sendKeysToElement(By.xpath(String.format(FORM_XPATH_PLACEHOLDER_INPUT, "Enter your last name")), "Hiep", true);
        sendKeysToElement(By.xpath(String.format(FORM_XPATH_PLACEHOLDER_INPUT, "Enter your email")), "vuhiep465@gmail.com", true);
        sendKeysToElement(By.xpath(String.format(FORM_XPATH_PLACEHOLDER_INPUT, "Enter your mobile number")), "0327457186", true);
        sendKeysToElement(By.xpath(String.format(FORM_XPATH_PLACEHOLDER_INPUT, "Enter your subjects")), "Automation Web Testing", true);
        ...
        // Interact with hobbies checkboxes
        ...
        // Interact with date of birth
        sendKeysToElement(By.xpath(dateDobXPath), "09102003", true);

        // Interact with address textarea
